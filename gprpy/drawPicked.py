...
mygpr = gp.gprpy2d()
mygpr.importdata('/home/alainplattner/Desktop/MySoftware/Git/GPRPy/exampledata/GSSI/FILE____032.DZT')
mygpr.setZeroTime(5)
mygpr.dewow(99999999)
mygpr.remMeanTrace(9999999999999)
...
# mygpr.printProfile('myFig.pdf', color='bwr', contrast=4, yrng=[16.5,19.7], xrng=[0,20.8], asp=2, dpi=600)
