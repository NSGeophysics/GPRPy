...
import collapsiblepane
import customtkinter as ctk


class CustomCollapsiblePane(ttk.Frame):
    ...
    def __init__(self, parent, expanded_text="Collapse <<",
        ...
        # self._button = ctk.CTkButton(self, parent, command=self._activate)
        self._button = ttk.Checkbutton(self, variable = self._variable, style="TButton",
